...
public class GarlandItem extends Item implements ICurioItem {
    ...
    public Multimap<Attribute, AttributeModifier> getAttributeModifiers(SlotContext slotContext, UUID uuid, ItemStack stack) {
        ...
        map.put(PasterdreamModAttributes.SAN_VARIABILITY.get(),new AttributeModifier(uuid,"pasterdream.garland.san_variability",0.48, AttributeModifier.Operation.ADDITION));
        return map;
    }
	@Override
